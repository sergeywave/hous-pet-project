# [Single-page website](https://sergeywave.github.io/hous-pet-project/) (pet-project)
...
# Одностраничный сайт бренда (пет-проект)
...
- Оптимизация кода и графики сайта. Показатели 100 по Google PageSpeed Insights.
